...
short dianziluopan_Anal_Data( )
{
  ...
  if((Uart1RxTemp[7]&0xf0) == 0)
	 {
	    shuipingfuyangjiao = (Uart1RxTemp[7]&0x0f)*10000+((Uart1RxTemp[7]&0xf0)>>4)*100000+(Uart1RxTemp[8]&0x0f)*100+((Uart1RxTemp[8]&0xf0)>>4)*1000+(Uart1RxTemp[9]&0x0f)+((Uart1RxTemp[9]&0xf0)>>4)*10;
	 }
	 if(((Uart1RxTemp[7]&0xf0)>>4) == 1)
	 {
	    shuipingfuyangjiao = (Uart1RxTemp[7]&0x0f)*10000+(Uart1RxTemp[8]&0x0f)*100+((Uart1RxTemp[8]&0xf0)>>4)*1000+(Uart1RxTemp[9]&0x0f)+((Uart1RxTemp[9]&0xf0)>>4)*10;
